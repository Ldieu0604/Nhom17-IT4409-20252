...
export function CommentItem({
    ...
    const activeBgColor = "#dbeafe";
    const activeBorderColor = "#60a5fa";
    ...
    return (
        <div
            ...
            style={{
                ...
                backgroundColor: isActive ? activeBgColor : undefined,
                boxShadow: isActive ? `0 0 0 1px ${activeBorderColor}` : undefined
            }}
            className={[
