 ...
 * own.
 */
export declare const CodeIndentExtension: import("lexical").LexicalExtension<CodeIndentConfig, "@lexical/code-indent", import("@lexical/extension").NamedSignalsOutput<CodeIndentConfig>, unknown>;
